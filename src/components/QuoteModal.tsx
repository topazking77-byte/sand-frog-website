            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl z-[60] overflow-hidden p-8 md:p-12 w-[calc(100%-2rem)]"
                    >
                        <button
                            onClick={onClose}
                        ...
                        <div className="relative">
                            <QuoteIcon className="absolute -top-4 -left-4 w-12 h-12 text-emerald-500/20" />
                            ...
                            <div className="text-center">
                                <cite className="text-emerald-400 font-bold text-lg not-italic block mb-2">— {quote.author}</cite>
                                <p className="text-slate-400 text-sm italic">{quote.context}</p>
                            </div>
                        </div>
